...
export const predictions = [
  {
    modelMajorArcane: allGlbs.Card1,
    textMajorArcane: "je suis le texte de l'arcane majeur prediction 1",
    modelMinorArcane: allGlbs.Card2,
  ...
  },
  {
    ...
    textMajorArcane: "je suis le texte de l'arcane majeur prediction 2",
